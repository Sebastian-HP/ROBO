...
/* digital input ports */
byte reportPINs[19];       // 1 = report this port, 0 = silence
byte previousPINs[19];     // previous 8 bits sent

/* pins configuration */
byte pinConfig[13];         // configuration of every pin
byte portConfigInputs[19]; // each bit: 1 = pin in INPUT, 0 = anything else
int pinState[13];           // any value that has been written
